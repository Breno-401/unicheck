(function () {
    ...
    const faqItems = [
        ...
        { category: 'checklist', question: 'Meu progresso é salvo automaticamente?', answer: 'Sim. Ao concluir uma etapa, o progresso aparece imediatamente e o UniCheck tenta sincronizá-lo com sua conta em segundo plano. A conclusão é definitiva, mas a orientação continua disponível para revisão.' },
